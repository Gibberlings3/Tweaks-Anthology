...
EEex_GameState_AddInitializedListener(function()
	...
	EEex_Utility_NewScope(function()
		local resources = { "STRMOD", "STRMODEX", "DEXMOD", "STYLBONU", "SNEAKATT", "RACEFEAT", "GTABMOD", "MXSPLWIZ", "MXSPLPRS", "MXSPLSHM", "MXSPLDD", "MXSPLSRC", "MXSPLDRU", "THAC0", "SAVEWAR", "GTINTMOD" }
		--
	...
	-- IDS
	EEex_Utility_NewScope(function()
		local resources = { "EA", "GENERAL", "RACE", "CLASS", "GENDER", "ALIGN", "ITEMFLAG", "STATE", "STATS", "SPELL", "GTSPELL", "ANIMATE", "PROJECTL" }
		--
		for _, v in ipairs(resources) do
